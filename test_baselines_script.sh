...
python test_baselines.py \
    --model_type resnet \
    --pretrained_path /mnt/user_data/yifei/models/med_cv/resnet-50 \
    --ckpt_path /home/yifei/code/Med_CV/MedMamba/logs/Spatial_Task_ResNet/bs64_ep1000_lr0.0001/2025-10-23-09-09-58/best.pth \
    --num_classes 4 \
...
python test_baselines.py \
    --model_type convnext \
    --pretrained_path /mnt/user_data/yifei/models/med_cv/convnext-tiny-224 \
    --ckpt_path /home/yifei/code/Med_CV/MedMamba/logs/Spatial_Task_ConvNeXt/bs64_ep1000_lr0.0001/2025-10-25-03-02-35/best.pth \
    --num_classes 4 \
    --test_root_dir /home/yifei/code/Med_CV/MedMamba/dataset/4_spatial_task/test
...
python test_baselines.py \
    --model_type swin \
    --pretrained_path /mnt/user_data/yifei/models/med_cv/swin-tiny-patch4-window7-224 \
    --ckpt_path /home/yifei/code/Med_CV/MedMamba/logs/Spatial_Task_Swin/bs64_ep1000_lr0.0001/2025-10-25-06-23-22/last.pth \
    --num_classes 4 \
